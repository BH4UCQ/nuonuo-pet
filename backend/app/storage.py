...
class DeviceRecord:
    ...
    bind_expires_at: Optional[float] = None
...
ASSET_MANIFEST: List[Dict[str, Any]] = [
    {"id": "cat-default", "type": "species-template", "version": "0.1.0", "description": "Default cat species template."},
    {"id": "cat-gold-day", "type": "theme-pack", "version": "0.1.0", "description": "Golden cat daytime theme pack."},
    {"id": "cat-silver-night", "type": "theme-pack", "version": "0.1.0", "description": "Silver cat night theme pack."},
    {"id": "monkey-default", "type": "species-template", "version": "0.1.0", "description": "Default monkey species template."},
    {"id": "monkey-sun", "type": "theme-pack", "version": "0.1.0", "description": "Monkey sunshine theme pack."},
    {"id": "dino-default", "type": "species-template", "version": "0.1.0", "description": "Default dino species template."},
    {"id": "dino-green", "type": "theme-pack", "version": "0.1.0", "description": "Green dino theme pack."},
]
